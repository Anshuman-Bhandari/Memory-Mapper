...
function Visualise() {
  ...
  return (
    <div id="allocation-section" className="min-h-[95vh] w-full flex flex-col items-center justify-center p-5 mt-16">
      <div className="min-h-[10vh] mt-4 text-4xl font-light">
        <span className="text-red-500">Memory Allocation</span> Algorithms
      </div>
      ...
      <div className="w-full flex flex-col items-center justify-center">
        <div className="text-3xl flex  items-center justify-start font-light w-full pl-52 pb-12 text-red-500">
          Memory
        </div>
